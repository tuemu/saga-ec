...
This is a sample template for saga-ec - Below is a brief explanation of what we have generated for you:
...
```
cd saga-ec/functions/sample_function
```
...
aws cloudformation describe-stacks \
    --stack-name saga-ec --query 'Stacks[].Outputs'
```
